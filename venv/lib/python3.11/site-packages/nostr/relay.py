...
class Relay:
    ...
    def connect(self, ssl_options: dict=None):
        try:
            ...
            print(f"Connecting to WebSocket server at {self.url} with SSL options: {ssl_options}")
            print(f"WebSocketApp instance: {self.ws}")
            print(f"WebSocketApp URL: {self.ws.url}")
            print(f"WebSocketApp on_open: {self.ws.on_open}")
            print(f"WebSocketApp on_message: {self.ws.on_message}")
            print(f"WebSocketApp on_error: {self.ws.on_error}")
            print(f"WebSocketApp on_close: {self.ws.on_close}")
            print("Running WebSocketApp...")
            self.ws.run_forever(sslopt=ssl_options)
        except Exception as e:
            print(f"Failed to connect to WebSocket server at {self.url}")
            print(f"Exception in connect method: {e}")
    ...
    def _on_open(self, class_obj):
        print("WebSocket connection opened in _on_open.")
        print(f"self.ws.sock: {self.ws.sock}")

    def _on_close(self, class_obj, status_code, message):
        print(f"WebSocket closed with status code: {status_code}, message: {message}")
